...
const ASSETS = [
  {id: 'dashboard', label: 'Dashboard', iconName: 'dashboard', action: 'navigate', badge: 'PG'},
  {id: 'assetPrices', label: 'Asset Prices', iconName: 'chartUp', action: 'navigate'},
  {id: 'rewards', label: 'Rewards', iconName: 'rewards', action: 'navigate', badge: 'NEW', badgeType: 'new'},
];

const APP_SETTINGS = [
  {id: 'autopay', label: 'AutoPay', iconName: 'autopay', action: 'navigate'},
  {id: 'snapsave', label: 'SnapSave', iconName: 'snapsave', action: 'navigate'},
  {
    id: 'saveonspend',
  ...
  {id: 'referral', label: 'Referral Code', iconName: 'referral', action: 'navigate'},
  {id: 'activation', label: 'Activation Code', iconName: 'activation', action: 'navigate'},
  {id: 'reminder', label: 'Reminder settings', iconName: 'reminder', action: 'navigate'},
];

const GENERAL = [
  {id: 'bookAppointment', label: 'Book Appointment', iconName: 'calendar', action: 'navigate'},
  {id: 'orders', label: 'My Orders', iconName: 'orders', action: 'navigate'},
  {id: 'security', label: 'Security & Permission', iconName: 'security', action: 'navigate'},
  {id: 'helpSupport', label: 'Help & Support', iconName: 'help', action: 'navigate'},
  {id: 'mission', label: 'Our Mission & Vision', iconName: 'mission', action: 'navigate'},
  {id: 'reports', label: 'Reports', iconName: 'chart', action: 'navigate'},
  {id: 'deleteAccount', label: 'Delete Account', iconName: 'trash', action: 'navigate'},
  {id: 'aboutGullak', label: 'About TrueGold', iconName: 'info', action: 'navigate'},
  {id: 'about', label: 'About', iconName: 'info', action: 'navigate'},
  {id: 'shareFeedback', label: 'Share Feedback', iconName: 'share', action: 'navigate'},
];
